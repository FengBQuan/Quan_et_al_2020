...
%% Set MaxBendAmp Dataset

[DatasetPreEscape_GoodSwimmers_MaxBenAmp] = MaxBendAmpDataSet(DatasetPreEscape_GoodSwimmers);

DatasetPreEscape_GoodSwimmers_MaxBenAmp = rmfield(DatasetPreEscape_GoodSwimmers_MaxBenAmp, {'Trial_ID', 'Well_ID','NStim','EscapeWindow1', 'EscapeWindow2', 'Flag',...
    'NumBout', 'BoutStart', 'BoutEnd', 'fps', 'pixelSize', 'nframes', 'BoutDuration', 'TotalDistance', 'Speed', 'NumberOfOscillations', ...
    'AmplitudeOfAllBends', 'InstantaneousTBF', 'InstantaneousIBI', 'InstantaneousSpeed', 'angularVelocity', 'TailAngle_smoothed', 'HeadX', ...
    'HeadY', 'Heading', 'TailX_VideoReferential', 'TailY_VideoReferential', 'Bend_Timing', 'Bend_Amplitude','MedianBendAmp', 'Fish_ID'});
output=DatasetPreEscape_GoodSwimmers_MaxBenAmp;
Table_MaxBendAmpAllBouts=struct2table(output);
writetable(Table_MaxBendAmpAllBouts);
